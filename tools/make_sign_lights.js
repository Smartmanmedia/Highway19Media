...
fs.writeFileSync(path.join(DIR, 'ui-sign-lights.svg'), src);
...
console.log('ui-sign-lights.svg ' + (src.length/1024).toFixed(1) + ' KB, ' +
            'ui-sign-lights-board.svg ' + (board.length/1024).toFixed(1) + ' KB');
